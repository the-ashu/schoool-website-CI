		...
		<div class="container">
			...
			<!-- header -->
				<div class="logo-search">
					<div class="logo">
						<h1><a href="index.html">RI<span class="color">SI</span><span class="color1">N</span><span class="color2">G</span> <span>CHILD</span> <i>A play school</i></a></h1>
					</div>
					<div class="search">
						<form>
						...
						<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
							<nav class="stroke">
								<ul class="nav navbar-nav">
									...
									<li><a href="services.html" class="hvr-rectangle-out">Services</a></li>
									...
									<li><a href="mail.html" class="hvr-rectangle-out">Mail Us</a></li>
								</ul>
							</nav>
						</div>
						<!-- /.navbar-collapse -->
			...
			<div class="footer-grids">
				...
				<div class="col-md-3 footer-grid">
					<div class="footer-grid-left">
						<a href="single.html"><img src="images/10.jpg" alt=" " class="img-responsve" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single.html"><img src="images/12.jpg" alt=" " class="img-responsve" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single.html"><img src="images/11.jpg" alt=" " class="img-responsve" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single.html"><img src="images/10.jpg" alt=" " class="img-responsve" /></a>
					</div>
