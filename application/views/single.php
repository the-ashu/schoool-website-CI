				...
				<div class="single">
					<div class="col-md-8 single-left">
						<div class="single-left1">
							<img src="<?=base_url()?>Static/home/images/5.jpg" alt=" " class="img-responsive" />
							...
							<div class="comments-grids">
								<div class="comments-grid">
									<div class="comments-grid-left">
										<img src="<?=base_url()?>Static/home/images/3.png" alt=" " class="img-responsive" />
									</div>
								...
								<div class="comments-grid">
									<div class="comments-grid-left">
										<img src="<?=base_url()?>Static/home/images/4.png" alt=" " class="img-responsive" />
									</div>
									<div class="comments-grid-right">
										<h4><a href="#">Jennif Marry</a></h4>
										<ul>
											<li>28 March 2016 <i>|</i></li>
											<li><a href="#">Reply</a></li>
										</ul>
										<p>I will give you a complete 
											account of the system, and expound the actual teachings of the great 
								...
								<div class="comments-grid">
									...
									<div class="comments-grid-right">
										...
										<p>I will give you a complete 
											account of the system, and expound the actual teachings of the great 
											explorer of the truth, the master.</p>
									</div>
									<div class="clearfix"> </div>
								</div>
								<div class="comments-grid">
									<div class="comments-grid-left">
										<img src="<?=base_url()?>Static/home/images/5.png" alt=" " class="img-responsive" />
									</div>
									<div class="comments-grid-right">
										<h4><a href="#">Federick</a></h4>
										<ul>
											<li>30 March 2016 <i>|</i></li>
											<li><a href="#">Reply</a></li>
										</ul>
										<p>I will give you a complete 
											account of the system, and expound the actual teachings of the great 
